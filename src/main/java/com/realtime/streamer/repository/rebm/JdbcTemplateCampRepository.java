...
public class JdbcTemplateCampRepository implements CampRepository{
    ...
    public List<Camp> getCampList() {
        return rebmJdbcTemplate.query(" SELECT CAMP_ID, CAMP_NM, CAMP_STAT, CAMP_STR_DT, CAMP_END_DT  FROM R_PLAN ", campRowMapper());
        /*
    ...
    public Camp getCampOne(String id) {
        Camp camp = rebmJdbcTemplate.queryForObject(
    ...
    public Optional<Camp> findById(String id) {
        List<Camp> result = rebmJdbcTemplate.query(" SELECT CAMP_ID, CAMP_NM, CAMP_STAT, CAMP_STR_DT, CAMP_END_DT " +
    ...
    public List<Camp> getDetcChanList() {
        ...
        List<Camp> result = rebmJdbcTemplate.query(" SELECT B.DETC_CHAN_CD, COUNT(*) AS CNT"
